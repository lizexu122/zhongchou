                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th class="dropdown">
                                ...
                                <ul class="dropdown-action" style="left: -10px;">
...
<footer>
    <p>Copyright &copy; 2018.&nbsp;Wendy&nbsp;CoolLi&nbsp; All rights reserved.</p>
</footer>
</body>
<script>
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            str += "<tr>" +
                                ...
                                "<td>" + (data[i].address==null?"":data[i].address.zone+'-'+data[i].address.detail) + "</td>" +
